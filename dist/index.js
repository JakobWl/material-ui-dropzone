...
var _createClass$1 = _interopDefault(require('@babel/runtime/helpers/esm/createClass'));
...
function StylesProvider(props) {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(StylesContext.Provider, {
    value: value,
    children: children
  });
}
...
function makeStyles(stylesOrCreator, options = {}) {
  ...
  const useStyles = (props = {}) => {
    ...
    const stylesOptions = _extends$1({}, React.useContext(StylesContext), stylesOptions2);
...
const withStyles = (stylesOrCreator, options = {}) => Component => {
  ...
  const WithStyles = /*#__PURE__*/React.forwardRef(function WithStyles(props, ref) {
    ...
    return /*#__PURE__*/jsxRuntime.jsx(Component, _extends$1({
      ref: ref,
      classes: classes
    }, more));
  });
